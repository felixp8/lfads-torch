...
def compute_l2_penalty(lfads, hps):
    recurrent_kernels_and_weights = [
        (lfads.encoder.ic_enc.fwd_rnn.cell.rec_weight, hps.l2_ic_enc_scale),
        (lfads.encoder.ic_enc.fwd_rnn.cell.rec_weight, hps.l2_ic_enc_scale),
        (lfads.decoder.rnn.cell.gen_cell.rec_weight, hps.l2_gen_scale),
    ]
    if lfads.use_con:
        recurrent_kernels_and_weights.extend(
            [
                (lfads.encoder.ci_enc.fwd_rnn.cell.rec_weight, hps.l2_ci_enc_scale),
                (lfads.encoder.ci_enc.fwd_rnn.cell.rec_weight, hps.l2_ci_enc_scale),
                (lfads.decoder.rnn.cell.con_cell.rec_weight, hps.l2_con_scale),
            ]
        )
